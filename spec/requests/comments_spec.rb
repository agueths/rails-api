...
RSpec.describe '/comments', type: :request do
  article = if Article.exists?(id: 1)
  ...
  let(:valid_attributes) do
    { article_id: article.id, name: 'Alexandre', comment: 'E vem mesmo' }
  end

  let(:invalid_attributes) do
    { article_id: nil, name: 'Alexandre', comment: 'E vem mesmo' }
  end
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      let(:new_attributes) do
        { name: 'Teste', comment: 'Comentário alterado' }
      end
      ...
      it 'updates the requested comment' do
        ...
        expect(response.content_type).to match(a_string_including('application/json'))
        expect(response.body).to include new_attributes[:name]
        expect(response.body).to include new_attributes[:comment]
      end
